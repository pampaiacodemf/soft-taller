...
export async function approveBudget(budgetId: string) {
    ...
    if (budget.workOrderId && budget.workOrder) {
        const prevStatus = budget.workOrder.status;
        await prisma.workOrder.update({
            ...
            data: {
                ...
                statusHistory: {
                    create: {
                        ...
                        toStatus: "APROBADO",
                        note: `Presupuesto #${budget.budgetNumber ?? budgetId.slice(-6)} aprobado`,
                    },
                },
            },
        });
            ...
            data: {
                ...
                statusHistory: {
                    create: {
                        fromStatus: prevStatus,
                        toStatus: "RECHAZADO",
                        note: `Presupuesto #${budget.budgetNumber ?? budgetId.slice(-6)} rechazado por el cliente`,
                    },
                },
            },
        });
