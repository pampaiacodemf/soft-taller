        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex-1 overflow-x-auto scrollbar-hide">
                    <FilterTabs 
                        paramName="tipo" 
                        options={{ "A": "Factura A", "B": "Factura B", "C": "Factura C" }} 
                        allLabel="Todos los tipos"
                    />
                </div>
                <div className="bg-primary/5 px-4 py-2 rounded-lg border border-primary/10">
                    <p className="text-xs font-semibold text-primary uppercase">Total Facturado</p>
                    <p className="text-xl font-bold">{formatCurrency((invoices as any[]).reduce((sum, i) => sum + i.total, 0))}</p>
                </div>
            </div>
