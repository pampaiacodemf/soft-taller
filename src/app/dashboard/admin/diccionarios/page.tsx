...
export default async function DictionaryAdminPage({
    ...
    if (!session || !["ADMIN", "ADMIN_STAFF", "SUPER_ADMIN"].includes(session.user.role)) {
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1">
                        Administrá los Tipos, Marcas y Modelos del sistema.
                    </p>
                </div>
                <SearchInput placeholder="Buscar término..." className="w-full sm:w-64" />
            </div>
